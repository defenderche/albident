...
**Обновлено:** 2026-05-31 (design-system-port: дизайн-система перенесена в код).
...
2. Контент: hero-визуал и полоса статистики на главной (отложены в design-system-port — нужны ассеты/значения).
