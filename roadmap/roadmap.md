...
**Обновлено:** 2026-05-31 (design-map: графическая карта / дизайн-система).
...
2. Дизайн-язык: графическая карта / UI-система собрана (`design-map/index.html`) — осталось применить визуальный слой к реальным страницам.
